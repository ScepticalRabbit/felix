...
19. **Use approximations only with an accuracy contract.** Fast maths, LUTs, lower precision, and reduced sampling are valid only when verification shows they preserve the required render and DIC behaviour.
